      ...
      <div className="contact container mx-auto pt-32 mb-[500px] md:mb-[600px] lg:mb-[650px]">
        <div className="text-center">
          ...
          <h1 className="text-xl md:text-5xl font-bold text-black md:w-[65apx]">
            Jika Anda memiliki pertanyaan, jangan ragu untuk <br />
            menghubungi kami
          </h1>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 mt-10 ">
          <div className="phone flex mb-4">
            ...
            <div className="detail-phone">
              <p className="ml-10 text-sm md:text-base text-black font-bold">
                Telepon untuk menanyakan pertanyaan apa pun
              </p>
          ...
          <div className="email flex mb-4">
            ...
            <div className="detail-email">
              <p className="ml-10 text-sm md:text-base text-black font-bold">
                Email untuk mendapatkan penawaran gratis
              </p>
              <p className="ml-10 text-sm md:text-base text-[#29BF08] font-bold">
        ...
        {/* <div className="grid grid-cols-1 mt-10 bg-[#29BF08] h-[300px] md:h-[500px] lg:h-[700px] w-[70%] mb-20 mx-auto rounded-md">
